...
pytestmark = [
    pytest.mark.ca65,
    pytest.mark.skipif(not language_server_tests_enabled(LanguageServerId.CA65), reason="CA65 tests disabled (cc65 not installed?)"),
]
...
class TestCa65LanguageServer:
    ...
    @pytest.mark.parametrize("language_server", [LanguageServerId.CA65], indirect=True)
    @pytest.mark.parametrize("repo_path", [LanguageServerId.CA65], indirect=True)
